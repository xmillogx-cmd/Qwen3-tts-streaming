...
Перенесено из faster-qwen3-tts/faster_qwen3_tts/sampling.py с минимальной адаптацией.
"""
...
def sample_logits(
    ...
    *,
    ...
    """Sample a token from logits. Mirrors HF order: suppress -> temperature -> top-k -> top-p -> sample."""
    logits = logits.clone()
